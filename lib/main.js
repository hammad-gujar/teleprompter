...
let streamAudioToWebSocket = function (userMediaStream) {
    ...
    console.log('prog : ', progressBarStatus);
    speechEvents.on('speaking', function() {
        console.log('spkeakingggg.....', !progressBarStatus, active, pause);
        if(active) {
            startProgressBar();
...
$('#turnOn-button-right').click(function () {
    openSocket();
});
...
function toggleStartStop(disableStart = false) {
    $('#turnOn-button-right').prop('disabled', disableStart);
