            ...
            */
            ...
            function getTranscrriberWord(results){
                ...
                return {'word': word, 'responseString': responseString};
            }
            ...
            */
            function compareString (results) {
                ...
                transcriberResponse = getTranscrriberWord(results);
               ...
               // console.log('transcriberWord..........', transcriberWord);
                ...
                if (jump && transcriberResponse.responseString) {
                ...
                while (currentIndex < windowEndIndex
                    ...
                    if(algo == 'LevenshteinDistance') {
                        ...
                        if(calculateJaroDistance(scriptCurrentWord, transcriberWord) > 0.96) {
                            ...
                            if(jumpTimerIsOn) {
                                console.log('clearrrrrrrrrrrrrrrrrrr');
            ...
            function jumpPromopterToSentence(transcriberString) {
                console.log('................................................................. ');
                console.log('transcriberString : ',transcriberString);
                ...
                var currentStringIndex = nextStringNumber;
                console.log('next index : ', nextStringNumber, stringWindowEndIndex);
                while(nextStringNumber < stringWindowEndIndex
                    && nextStringNumber <= subStringsArray.length
                    && stringWindowEndIndex <= subStringsArray.length) {
                    var newDistance = calculateJaroDistance(subStringsArray[nextStringNumber], transcriberSubString);
                
                    if(newDistance > 0.7) {
                         if(newDistance > distance) {
                             console.log('newDistance : ', newDistance, currentStringIndex);
                             distance = newDistance;
                             var stringWords = document.querySelectorAll('[stringindex="'+currentStringIndex+'"]');
                             ...
                             stringFound = true;
                             console.log(subStringsArray[currentStringIndex], ' ::: ', transcriberSubString, ' ::: ', newDistance);
